...
{{
var G__13873 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13873;
continue;
}
} else
...
{var pred__13877 = cljs.core._EQ_;var expr__13878 = limit;if(cljs.core.truth_(pred__13877.call(null,1,expr__13878)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13877.call(null,2,expr__13878)))
...
var G__13880 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13881 = (limit__$1 - 1);
var G__13882 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13880;
limit__$1 = G__13881;
parts = G__13882;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13884 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13884))
{var replacement_13885 = temp__4124__auto___13884;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13885)));
} else
{buffer.append(ch);
}
{
