...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj10946 = {};return obj10946;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7128__auto__ = this$;if(and__7128__auto__)
...
{var x__7767__auto__ = (((this$ == null))?null:this$);return (function (){var or__7140__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__7767__auto__)]);if(or__7140__auto__)
{return or__7140__auto__;
} else
{var or__7140__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7140__auto____$1)
...
return (function (p__10947){var vec__10948 = p__10947;var k = cljs.core.nth.call(null,vec__10948,0,null);var v = cljs.core.nth.call(null,vec__10948,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10949){var vec__10950 = p__10949;var k = cljs.core.nth.call(null,vec__10950,0,null);var v = cljs.core.nth.call(null,vec__10950,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
