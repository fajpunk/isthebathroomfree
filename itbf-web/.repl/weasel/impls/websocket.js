...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj11075 = {};return obj11075;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__7128__auto__ = this$;if(and__7128__auto__)
...
{var x__7767__auto__ = (((this$ == null))?null:this$);return (function (){var or__7140__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__7767__auto__)]);if(or__7140__auto__)
{return or__7140__auto__;
} else
{var or__7140__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__7140__auto____$1)
...
return (function (p__11076){var vec__11077 = p__11076;var k = cljs.core.nth.call(null,vec__11077,0,null);var v = cljs.core.nth.call(null,vec__11077,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
