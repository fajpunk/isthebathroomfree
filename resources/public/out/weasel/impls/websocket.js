...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj5116 = {};return obj5116;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__3526__auto__ = this$;if(and__3526__auto__)
...
{var x__4165__auto__ = (((this$ == null))?null:this$);return (function (){var or__3538__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__4165__auto__)]);if(or__3538__auto__)
{return or__3538__auto__;
} else
{var or__3538__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__3538__auto____$1)
...
return (function (p__5117){var vec__5118 = p__5117;var k = cljs.core.nth.call(null,vec__5118,0,null);var v = cljs.core.nth.call(null,vec__5118,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
