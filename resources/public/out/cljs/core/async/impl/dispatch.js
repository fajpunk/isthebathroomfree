...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13623 = 0;while(true){
var m_13624 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13624 == null))
{} else
{m_13624.call(null);
if((count_13623 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13625 = (count_13623 + 1);
count_13623 = G__13625;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3542__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3542__auto__)
